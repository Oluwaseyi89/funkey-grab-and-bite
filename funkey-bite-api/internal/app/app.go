...
// SetupEngine handles the complete dependency injection and routing configurations.
// It returns the configured gin instance and a cleanup function to close the database safely.
